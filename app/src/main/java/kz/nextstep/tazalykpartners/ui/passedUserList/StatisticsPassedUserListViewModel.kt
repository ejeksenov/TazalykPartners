    ...
    if (!dataList.isNullOrEmpty()) {
            ...
            for (item in dataList) {
                ...
                if (!userId.isNullOrEmpty()) {
                    if (!userListHashMap.containsKey(userId)) {
                                ...
                                if (!t.isNullOrEmpty()) {
                                    for (key in t.keys) {
                                        ...
                                        if (user != null) {
                                            ...
                                            Toast.makeText(MainApplication.INSTANCE?.applicationContext, passedUserList.size.toString(), Toast.LENGTH_SHORT).show()
                                        }
                                    }
                                }
                            }
                        ...
                        val user = userListHashMap[userId]
                        if (user != null) {
                            passedUserList.add(
                                PassedUserItem(
                                    user.userName,
